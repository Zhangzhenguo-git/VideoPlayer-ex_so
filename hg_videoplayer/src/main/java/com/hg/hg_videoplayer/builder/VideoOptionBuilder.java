package com.hg.hg_videoplayer.builder;

import android.graphics.drawable.Drawable;
import android.view.View;

import com.hg.hg_videoplayer.view.BaseVideoPlayerView;
...
public class VideoOptionBuilder extends GSYVideoOptionBuilder {
    ...
    //滤镜
    protected GSYVideoGLView.ShaderInterface mEffectFilter = (GSYVideoGLView.ShaderInterface) new NoEffect();
     ...
     * 进度回调
     */
    public VideoOptionBuilder setGSYVideoProgressListener(GSYVideoProgressListener videoProgressListener) {
     ...
     * 设置滤镜效果
     */
    public VideoOptionBuilder setEffectFilter(GSYVideoGLView.ShaderInterface effectFilter) {
    ...
    public void build(BaseVideoPlayerView gsyVideoPlayer) {
    ...
    public void build(GSYBaseVideoPlayer gsyVideoPlayer) {
        ...
        gsyVideoPlayer.setEffectFilter((GSYVideoGLView.ShaderInterface) mEffectFilter);
